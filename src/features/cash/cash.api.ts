...
import type { CashMovement,CashMovementType,CashRegister,CashSession } from './cash.types'
...
export const createCashRegister=(input:{establishmentId:string;name:string;code:string;active:boolean})=>apiRequest<CashRegister>('/v1/cash-registers',{
  method:'POST',
